...
void main() {
  group('3. Teacher Module Integration Tests', () {
    ...
    test('Test 3.2: Teacher Permission Gates', () {
      ...
      expect(checkUserPermission(db, teacherId, 'read:student_data'), isTrue);
      expect(checkUserPermission(db, teacherId, 'update:student_data'), isTrue);
      expect(checkUserPermission(db, teacherId, 'manage:users'), isFalse);
    });
