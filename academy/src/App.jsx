...
import { PublicOnboardPage } from './modules/auth/pages/PublicOnboardPage';
import { UserActivationPage } from './modules/auth/pages/UserActivationPage';
...
import { RolePermissionsMatrixPage } from './modules/admin/pages/RolePermissionsMatrixPage';
import { LectureManager } from './modules/admin/pages/LectureManager';
      ...
      <AuthProvider>
        <Router>
          <Routes>
            ...
            <Route path="/onboard" element={<PublicOnboardPage />} />
            <Route path="/onboard/status" element={<PublicOnboardPage />} />
            <Route path="/onboard/activate" element={<UserActivationPage />} />
