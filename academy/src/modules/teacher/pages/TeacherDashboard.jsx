  ...
  const [students, setStudents] = useState([
    {
      ...
      attendance: '96%',
      gpa: '3.8',
      notes: 'Excellent performance in Mathematics and Physics. Consistent participant in class discussions.',
    },
    {
      id: 102,
      name: 'Bilal Ahmed',
      ...
      attendance: '88%',
      gpa: '3.2',
      notes: 'Good progress in Science subjects. Needs additional focus on Chemistry lab write-ups.',
    },
    {
      id: 103,
      name: 'Zainab Fatima',
      ...
      attendance: '94%',
      gpa: '3.9',
      notes: 'Outstanding essay submissions. Active in student council activities.',
    },
  ]);

  const [selectedStudent, setSelectedStudent] = useState(students[0]);
  const [noteText, setNoteText] = useState(students[0]?.notes || '');
